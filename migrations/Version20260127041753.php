    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(
            ...
            SELECT id, location_id, name, description, inventory_number, serial_number, category,
                specifications, created_at, updated_at, balance_type, status, type, purchase_price,
                purchase_date, commissioning_date, responsible_person, checked FROM inventory_item'
        );
        ...
        $this->addSql(
            'INSERT INTO inventory_item (id, location_id, name, description, inventory_number,
                ...
                purchase_price, purchase_date, commissioning_date, responsible_person, checked)
            SELECT id, location_id, name, description, inventory_number, serial_number, category, specifications,
                created_at, updated_at, balance_type, status, type, purchase_price, purchase_date, commissioning_date,
                responsible_person, checked FROM __temp__inventory_item'
        );
